...
public class StudentActivity extends AppCompatActivity
    ...
    ListView mycourse;
    public ArrayList<String> mycontent = new ArrayList<String>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mycourse = (ListView)findViewById(R.id.mycourseList);

        mycontent.add("C++");
        mycontent.add("JAVA");

        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,mycontent);
        ...
        mycourse.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("CourseName", mycontent.get(position));
